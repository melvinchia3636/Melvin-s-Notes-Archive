...
So yeah... Yet another solution book for the UEC Mathematics Syllabus. I was
originally planning to start getting into Senior 3 Maths in the second semester
of the year, but I decided to start early because I was bored. Furthermore,
when I was getting started on solving some past year papers from Singapore, I
realised that there were some calculus questions that I didn't know how to
solve. So, I decided to start on this book early so that I can get a head start
on the syllabus.

This book is the English translated version of our Senior 3 Math Part I
textbook. I've tried my best to translate the descriptions and questions as
accurately as possible, but there might be some mistakes here and there. You
may realise that this book has a lot more pages than the previous two books
that I have written. This is because I have decided not to squeeze all the
solution in two columns per page, and also decided to use a larger font size
for this book, as I feel that it is more comfortable to read like that.
...
I would like to thank myself for yet again wasting my life to complete this
book. I would also like to thank my parents for sponsoring the printing of this
book. Special thanks to my comfy bed for being there for me when I was too lazy
to do anything.
...
\begin{enumerate}
      ...
      \item Find the limit of the following:
            \begin{enumerate}
                  \item $\lim\limits_{x\to0}{\dfrac{\sin{4x}}{x}}$
                        \sol{}
                        \begin{flalign*}
                              \lim\limits_{x\to0}{\dfrac{\sin{4x}}{x}} & = \lim\limits_{x\to0}{\dfrac{4\sin{4x}}{4x}} \\
                                                                       & = 4\lim\limits_{x\to0}{\dfrac{\sin{4x}}{4x}} \\
                                                                       & = 4(1)                                       \\
                                                                       & = 4
                        \end{flalign*}
                  ...
                  \item $\lim\limits_{x\to0}{\dfrac{\tan2x}{\tan5x}}$
                        \sol{}
                        \begin{flalign*}
                              \lim\limits_{x\to0}{\dfrac{\tan2x}{\tan5x}} & = \lim\limits_{x\to0}{\dfrac{2\tan2x}{2\tan5x}}                                                                                 \\
                                                                          & = \lim\limits_{x\to0}{\left(\dfrac{\sin2x}{\cos2x} \cdot \dfrac{\cos5x}{\sin5x}\right)}                                         \\
                                                                          & = \lim\limits_{x\to0}{\left(\dfrac{\sin2x}{2x} \cdot \dfrac{5x}{\sin5x} \cdot \dfrac{\cos5x}{\cos2x} \cdot \dfrac{2}{5}\right)} \\
                                                                          & =  \dfrac{2}{5}\lim\limits_{x\to0}{\dfrac{\cos5x}{\cos2x}}                                                                      \\
                                                                          & =  \dfrac{2}{5}
                        \end{flalign*}
                        \newpage
                  \item $\lim\limits_{x\to0}\dfrac{x^{2}}{\tan^{2}3x}$
                        \sol{}
                        \begin{flalign*}
                              \lim\limits_{x\to0}\dfrac{x^{2}}{\tan^{2}3x} & = \lim\limits_{x\to0}{\left(\dfrac{x}{\tan3x}\right)}^{2}                \\
                                                                           & = \lim\limits_{x\to0}{\left(\dfrac{x\cos3x}{\sin3x}\right)}^{2}          \\
                                                                           & = \lim\limits_{x\to0}{\left(\dfrac{3x}{3\sin3x} \cdot \cos3x\right)}^{2} \\
                                                                           & = \dfrac{1}{9}\lim\limits_{x\to0}{\left(\dfrac{3x}{\sin3x}\right)}^{2}   \\
                                                                           & = \dfrac{1}{9}
                        \end{flalign*}
                  ...
                  \item $\lim\limits_{x\to\infty}{\left(1+{\dfrac{1}{x}}\right)}^{4x+1}$
                        \sol{}
                        \begin{flalign*}
                              \lim\limits_{x\to\infty}{\left(1+{\dfrac{1}{x}}\right)}^{4x+1} & = \lim\limits_{x\to\infty}{\left[{\left(1+{\dfrac{1}{x}}\right)}^{4x} \cdot {\left(1+{\dfrac{1}{x}}\right)}\right]} \\
                                                                                             & = \lim\limits_{x\to\infty}{\left[{\left(1+{\dfrac{1}{x}}\right)}^{x}\right]^4}                                      \\
                                                                                             & = e^{4}
                        \end{flalign*}
                  ...
                  \item $\lim\limits_{x\to0}{\left(1-3x\right)}^{\frac{2}{x}}$
                        \sol{}
                        \begin{flalign*}
                              \lim\limits_{x\to0}{\left(1-3x\right)}^{\frac{2}{x}} & = \lim\limits_{x\to0}{\left[{\left(1-3x\right)}^{\frac{1}{3x}}\right]}^{-6} \\
                                                                                   & = \left[\lim\limits_{x\to0}{\left(1-3x\right)}^{\frac{1}{3x}}\right]^{-6}   \\
                                                                                   & = e^{-6}
                        \end{flalign*}
                  ...
                  \item $\lim\limits_{x\to\infty}{\left({\dfrac{x+3}{x+1}}\right)}^{x}$
                        \sol{}
                        \begin{flalign*}
                              \lim\limits_{x\to\infty}{\left({\dfrac{x+3}{x+1}}\right)}^{x} & = \lim\limits_{x\to\infty}{\left(1 + \dfrac{2}{x+1}\right)}^{x}                                                                               \\
                                                                                            & = \lim\limits_{x\to\infty}{\left\{\left[\left(1 + \dfrac{2}{x+1}\right)^{\frac{x + 1}{2}}\right]^2 - \left(1 + \dfrac{2}{x+1}\right)\right\}} \\
                                                                                            & = \lim\limits_{x\to\infty}{\left[\left(1 + \dfrac{2}{x+1}\right)^{\frac{x + 1}{2}}\right]^2}                                                  \\
                                                                                            & = e^{2}
                        \end{flalign*}
            \end{enumerate}
      ...
      \item Find the derivative of the following functions:
            \begin{enumerate}
                  ...
                  \item $y=\cos^{4}2x$
                        \sol{}
                        \begin{flalign*}
                              y' & = 4\cos^{3}2x \cdot (-\sin2x) \cdot 2 \\
                                 & = -8\cos^{3}2x\sin2x
                        \end{flalign*}
                  ...
                  \item $y=\sec^{3}2x$
                        \sol{}
                        \begin{flalign*}
                              y' & = 3\sec^{2}2x \cdot \sec2x\tan2x \cdot 2 \\
                                 & = 6\sec^{3}2x\tan2x
                        \end{flalign*}
                  ...
                  \item $y=\sec^{2}(3x+5)$
                        \sol{}
                        \begin{flalign*}
                              y' & = 2\sec(3x+5) \cdot \sec(3x+5)\tan(3x+5) \cdot 3 \\
                  ...
                  \item $y=\sin2x\cos2x$
                        \sol{}
                        \begin{flalign*}
                              y' & = \cos2x\cos2x \cdot 2 + \sin2x(-\sin2x) \cdot 2 \\
                  ...
                  \item $y={\dfrac{1}{\sin x+\cos x}}$
                        \sol{}
                        \begin{flalign*}
                              y' & = \dfrac{-(\sin x+\cos x)'}{(\sin x+\cos x)^{2}} \\
                                 & = \dfrac{-(\cos x-\sin x)}{(\sin x+\cos x)^{2}}  \\
                                 & = \dfrac{\sin x-\cos x}{(\sin x+\cos x)^{2}}
                        \end{flalign*}

                  \item $y={\dfrac{\cos 5x}{\sin 3x}}$
                        \sol{}
                        \begin{flalign*}
                              y' & = \dfrac{(\cos 5x)' \cdot \sin 3x - \cos 5x \cdot (\sin 3x)'}{\sin^{2}3x} \\
                                 & = \dfrac{-5\sin 5x \cdot \sin 3x - \cos 5x \cdot 3\cos 3x}{\sin^{2}3x}    \\
                                 & = \dfrac{-5\sin 3x\sin 5x - 3\cos 3x\cos 5x}{\sin^{2}3x}
                        \end{flalign*}

                  \item $y={\dfrac{1+\cos x}{\sin x}}$
                        \sol{}
                        \begin{flalign*}
                              y' & = \dfrac{(\sin x)(1 + \cos x)' - (\sin x)'(1 + \cos x)}{(\sin x)^{2}} \\
                                 & = \dfrac{\sin x(-\sin x) - \cos x(1 + \cos x)}{(\sin x)^{2}}          \\
                                 & = \dfrac{-\sin^{2}x - \cos x - \cos^{2}x}{(\sin x)^{2}}               \\
                                 & = \dfrac{-1 - \cos x}{\sin^{2}x}
                        \end{flalign*}
            \end{enumerate}
      ...
      \item Find the derivative of the following functions:
            \begin{enumerate}
                  \item $y=5^{3x-2}$
                        \sol{}
                        \begin{flalign*}
                              y' & = 5^{3x-2} \cdot \ln 5 \cdot 3 \\
                                 & = 3 \cdot 5^{3x-2} \cdot \ln 5
                        \end{flalign*}
                  ...
                  \item $y=a^{3x}+e^{-3x}$
                        \sol{}
                        \begin{flalign*}
                              y' & = a^{3x} \cdot \ln a \cdot 3 + e^{-3x} \cdot (-3) \\
                                 & = 3a^{3x}\ln a - 3e^{-3x}
                        \end{flalign*}
      ...
      \item If the function $y = \dfrac{\sin 2x}{e^x}$, prove that $\dfrac{d^2y}{dx^2} +
                  2\dfrac{dy}{dx} + 5y = 0$. \sol{}
            \begin{flalign*}
                  \dfrac{dy}{dx}                            & = \dfrac{(\sin2x)'e^x - \sin2x(e^x)'}{(e^x)^{2}}                                                                         \\
                                                            & = \dfrac{(2\cos2x)e^x - (\sin2x)e^x}{e^{2x}}                                                                             \\
                                                            & = \dfrac{2\cos2x - \sin2x}{e^{x}}                                                                                        \\
                  \dfrac{d^2y}{dx}                          & = \dfrac{(2\cos2x - \sin2x)'(e^x) - (2\cos2x - \sin2x)(e^x)'}{(e^x)^{2}}                                                 \\
                                                            & = \dfrac{(-4\sin2x - 2\cos2x)e^x - (2\cos2x - \sin2x)e^x}{e^{2x}}                                                        \\
                                                            & = \dfrac{-4\sin2x - 2\cos2x - 2\cos2x + \sin2x}{e^{x}}                                                                   \\
                                                            & = \dfrac{-3\sin2x - 4\cos2x}{e^{x}}
                  \\
                  \dfrac{d^2y}{dx^2} + 2\dfrac{dy}{dx} + 5y & = \dfrac{-3\sin2x - 4\cos2x}{e^{x}} + 2\left(\dfrac{2\cos2x - \sin2x}{e^{x}}\right) + 5\left(\dfrac{\sin 2x}{e^x}\right) \\
                                                            & = \dfrac{-3\sin2x - 4\cos2x+ 4\cos2x - 2\sin2x + 5\sin 2x}{e^x}                                                          \\
                                                            & = \dfrac{0}{e^x}                                                                                                         \\
                                                            & = 0 \qed
            \end{flalign*}
      ...
      \item Find the derivative of the following functions:
            \begin{enumerate}
                  ...
                  \item $y=\ln\left(3x^{2}+6x\right)$
                        \sol{}
                        \begin{flalign*}
                              y' & = \dfrac{1}{3x^{2}+6x} \cdot (3x^2 + 6x)' \\
                                 & = \dfrac{6x + 6}{3x^2 + 6x}               \\
                                 & = \dfrac{6(x + 1)}{3(x^2 + 2x)}           \\
                                 & = \dfrac{2(x + 1)}{x^2 + 2x}              \\
                                 & = \dfrac{2x + 2}{x^2 + 2x}
                        \end{flalign*}
                  ...
                  \item $y=\ln\left(\sin^{2}4x\right)$
                        \sol{}
                        \begin{flalign*}
                              y' & = \dfrac{1}{\sin^{2}4x} \cdot (\sin^{2}4x)' \\
                                 & = \dfrac{8\sin4x\cos4x}{\sin^{2}4x}         \\
                                 & = \dfrac{8\cos4x}{\sin4x}                   \\
                                 & = 8\cot4x
                        \end{flalign*}
                  ...
                  \item $y=\log\left(x^{3}+3x-4\right)$
                        \sol{}
                        \begin{flalign*}
                              y' & = \dfrac{1}{x^{3}+3x-4} \cdot (x^3 + 3x - 4)' \\
                  ...
                  \item $y=\log_{2}{\dfrac{x}{x+3}}$
                        \sol{}
                        \begin{flalign*}
                              y' & = \dfrac{1}{\ln2\left(\dfrac{x}{x+3}\right)} \cdot \left(\dfrac{x}{x+3}\right)' \\
                                 & = \dfrac{x+3}{x\ln2} \cdot \dfrac{(x+3) - x}{(x+3)^2}                           \\
                                 & = \dfrac{3(x+3)}{x(x+3)^2\ln2}                                                  \\
                                 & = \dfrac{3}{x(x+3)\ln2}
                        \end{flalign*}
                  ...
                  \item $y={\dfrac{1+\log x}{1+\ln x}}$
                        \sol{}
                        \begin{flalign*}
                              y' & = \dfrac{(1+\log x)'(1+\ln x) - (1+\ln x)'(1+\log x)}{(1+\ln x)^2}                                                              \\
                                 & = \dfrac{\left(1+\dfrac{1}{x\ln 10}\right)(1+\ln x) - \left(1+\dfrac{1}{x}\right)(1+\log x)}{(1+\ln x)^2}                       \\
                                 & = \dfrac{1 + \ln x + \dfrac{1}{x\ln 10} +  \dfrac{\ln x}{x\ln 10} - 1 - \log x - \dfrac{1}{x} - \dfrac{\log x}{x}}{(1+\ln x)^2} \\
                                 & = \dfrac{\ln x + \dfrac{1 + \ln x}{x\ln 10} - \dfrac{1 + \log x}{x} - \log x}{(1+\ln x)^2}                                      \\
                                 & = \dfrac{\dfrac{x\ln10\ln x + 1 + \ln x - \ln10 - \ln10\log x - x\ln10\log x}{x\ln 10}}{(1+\ln x)^2}                            \\
                                 & = \dfrac{1 + \ln x - \ln10 - \ln10\log x}{x(1+\ln x)^2\ln 10}                                                                   \\
                                 & = \dfrac{1 + \ln x - \ln10 - \ln10\cdot\dfrac{\ln x}{\ln10}}{x(1+\ln x)^2\ln 10}                                                \\
                                 & = \dfrac{1 + \ln x - \ln10 - \ln x}{x(1+\ln x)^2\ln 10}                                                                         \\
                                 & = \dfrac{1 - \ln10}{x(1+\ln x)^2\ln 10}
                        \end{flalign*}
            \end{enumerate}
      ...
      \item If the function $y = \ln(x+1)$, find the value of $\dfrac{d^2y}{dx^2}$ when $x
                  = 1$. \sol{}
            \begin{flalign*}
                  \dfrac{dy}{dx}     & = \dfrac{1}{x+1} \cdot (x+1)'       \\
                                     & = \dfrac{1}{x+1}                    \\
                  \\
                  \dfrac{d^2y}{dx^2} & = \dfrac{(1)' - (1)(x+1)'}{(x+1)^2} \\
                                     & = \dfrac{0 - 1}{(x+1)^2}            \\
                                     & = -\dfrac{1}{(x+1)^2}
            \end{flalign*}
            When $x = 1$,
            \begin{flalign*}
                  \dfrac{d^2y}{dx^2} & = -\dfrac{1}{(1+1)^2} = -\dfrac{1}{4}
            \end{flalign*}
\end{enumerate}
