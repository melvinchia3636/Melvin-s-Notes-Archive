...
\begin{enumerate}
      ...
      \begin{multicols}{2}
            \item $y=x^2+4 x-21$, and $x$-axis\sol{}
            \begin{flalign*}
                  (x + 7)(x - 3)       & = 0 & \\
                  x = -7 \text{ or } x & = 3
            \end{flalign*}
            ...
            \begin{flalign*}
                  A & = \left|\int_{-7}^3 (x^2 + 4x - 21) d x\right|                                        & \\
                    ...
                    & = \left|9 + 18 - 63 - \left(-\dfrac{343}{3} + 98 + 147\right)\right| = \dfrac{500}{3}
            \end{flalign*}
      ...
      \item Find the area of the region bounded by the curve $x=8 y-y^2, x=16 y-y^2-48$,
            ...
            \begin{flalign*}
                  A & = \int_4^6 (16y - y^2 - 48) d y + \int_6^8 (8y - y^2) d y                                 & \\
                    & = \left[8y^2 - \dfrac{1}{3}y^3 - 48y\right]_4^6 + \left[4y^2 - \dfrac{1}{3}y^3\right]_6^8 & \\
                    & = 288 - 72 - 288 - 128 + \dfrac{64}{3} + 192 + 256 - \dfrac{512}{3} - 144 + 72            & \\
                    & = \dfrac{80}{3}
            \end{flalign*}
      ...
      \item Find the area of the region bounded by the curve $x=2 y^2-8 y+10$ and
            ...
            \begin{flalign*}
                  A & = \int_2^5 (y^2 - y - 2y^2 + 8y - 10) d y                        & \\
                    ...
                    & = \left[-\dfrac{1}{3}y^3 + \dfrac{7}{2}y^2 - 10y\right]_2^5      & \\
                    & = -\dfrac{125}{3} + \dfrac{175}{2} - 50 + \dfrac{8}{3} - 14 + 20 & \\
                    & = \dfrac{9}{2}
            \end{flalign*}
            ...
            \begin{multicols}{2}
                  ...
                  \begin{flalign*}
                        A & = \int_{-2}^{2} (x^3 - 3x + 2) d x                             & \\
                          & = \left[\dfrac{1}{4}x^4 - \dfrac{3}{2}x^2 + 2x\right]_{-2}^{2} & \\
                          & = 4 - 6 + 4 - 4 + 6 + 4                                        & \\
                          & = 8
                  \end{flalign*}
            \end{multicols}
