...
\begin{multicols}{2}
    ...
    A right circular cylinder is the solid of revolution generated by rotating a
    ...
    A right circular cone is the solid of revolution generated by rotating a
    ...
    is called a spherical surface, and the solid covered by it is called a sphere.
    ...
    great circle; the circle cut by a plane that does not pass through the centre
    of the sphere is called a small circle.

    \section{Angles Formed by Planes and Straight Lines}

    There are three types of angles formed by planes and straight lines:
    ...
    called the angle formed by the line and the plane. This angle represents the
    inclination of the line with respect to the plane, thus it is called the tilt
    angle of the line with respect to the plane.
    ...
    \begin{enumerate}
        \item In the diagram below, $AB = 9cm$, $BC = 7cm$, $CG = 5cm$. Find:
              \begin{enumerate}
                  \item The angle formed by the line $CF$ and the plane $GHDC$.
                  \item The angle formed by the line $DF$ and the plane $EFGH$.
              \end{enumerate}
        \item The diagram below shows a right prism, its base $KQL$ is a right-angled
              ...
              angle formed by the line $JQ$ and the plane $PQLM$.
    \end{enumerate}
    ...
    \begin{enumerate}
        \item The diagram below shows a cube with side length of $8.5cm$. Find:
              \begin{enumerate}
                  \item The angle formed by the line $QS$ and the plane $MNRQ$.
                  \item The angle formed by the line $KQ$ and the plane $PQML$.
              \end{enumerate}

        \item THe diagram below shows a cuboid, $AB = 8cm$, $BC = 6cm$, $AP = 10cm$. Find:
              \begin{enumerate}
                  \item The length of PR.
                  \item The angle formed by the line $SB$ and the plane $AQQB$.
              \end{enumerate}
        \item The diagram below shows a pyramid. Given that its base $PQRS$ is a square, $TR$
              ...
              \begin{enumerate}
                  ...
                  \item The angle formed by the line $PT$ and the plane $PQRS$.
              \end{enumerate}
        \item The diagram below shows a right pyramid with height of $8cm$, its base is a
              ...
              $BC = 6cm$. Find:
              \begin{enumerate}
                  \item The angle formed by the line $VA$ and $VE$.
                  \item The angle formed by the line $VC$ and the planew $ABCD$.
              \end{enumerate}
        \item The diagram below shows a right pyramid, its base $PQRS$ is a regtangle. Given
              ...
              \begin{enumerate}
                  ...
                  \item The angle of the line $VP$ and the plane $PQRS$.
              \end{enumerate}
        \item The diagram below shows a regular pyramid, the length of its lateral edge is
              ...
              \begin{enumerate}
                  ...
                  \item The angle formed by the line $VM$ and the base of the pyramid.
              \end{enumerate}
        \item In the pyramid shown below, $\Delta ABC$ is a right-angled triangle, $CD$ is
              ...
              \begin{enumerate}
                  ...
                  \item $\angle CDE$.
                  \item The angle formed by the line $AD$ and the plane $ABC$.
              \end{enumerate}
        \item The diagram below shows a right prism, its base $CDF$ is a right-angled
              ...
              find:
              \begin{enumerate}
                  \item The angle formed by the line $AB$ and the plane $BCFE$.
                  \item The angle formed by the line $AC$ and the plan $BCFE$.
              \end{enumerate}
        \item The diagram below shows a cuboid with volume of $300cm^3$. Given that $AD =
                  2DC$ and $DN = 9cm$. Find the angle formed by the line $AM$ and the plane
              $KLMN$.
        \item The diagram below shows a cuboid. Given that $AB = 13cm$, $BC = 6cm$, $CG =
                  4cm$. M is a point on $AB$, $AM = 9cm$. Find:
              \begin{enumerate}
                  \item The angle formed by the line $HM$ and the plane $ABCG$.
                  \item The angle formed by the line $HM$ and the plane $HDAE$.
                  \item The angle formed by the line $AG$ and the plane $CDHG$.
              \end{enumerate}
        \item The diagram below shows a regular prism, its base $ADS$ and $BCR$ is an
              equiliteral triangle. Given that $AB = 16cm$, $BC = 7cm$, $SP = 5cm$. Find:
              \begin{enumerate}
                  \item The length of $BP$.
                  \item The angle formed by the line $BP$ and the plane $ABCD$.
              \end{enumerate}
        \item The diagram below shows a roof, $HK$ is the ridge of the roof, its edges $HA$,
              ...
              $44^o$ angle with the plane $ABCD$. Given that $S$ and $T$ are the midpoints of
              $BC$ and $AD$ respectively. Find:
              \begin{enumerate}
                  \item The distance from the line $HK$ to the plane $ABCD$.
                  \item The length of $HK$.
                  \item The angle formed by the line $HA$ and the plane $ABCD$.
              \end{enumerate}
