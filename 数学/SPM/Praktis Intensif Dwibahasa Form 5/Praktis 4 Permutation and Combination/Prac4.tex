...
\begin{multicols*}{2}
      ...
      \begin{enumerate}
            ...
            \item Agnes decorates her hat with 18 artificial flowers. She uses the same number
                  ...
                  \begin{enumerate}
                        \item Find the number of roses used. \sol{}
                              \begin{flalign*}
                                    \text{Number of roses} & = \dfrac{18}{3 + 2 + 1} \times 3 \\
                                                           & = 9 \eos
                              \end{flalign*}
                        \item If the morning glories have to be side by side on both the hat and bracelet
                              find the total number of ways to arrange the artificial flowers. \sol{}

                              Since the morning glories have to be side by side, we treat the morning glories
                              as a single flower.

                              For the hat, there are $\dfrac{(13 - 1)!}{9!3!} = 220$ ways to arrange the
                              flowers.

                              For the bracelet, since the bracelet can be flipped, the clockwise and the
                              anticlockwise arrangement are considered as the same arrangement.

                              Hence, there are $\dfrac{(13 - 1)!}{2\times9!3!} = 110$ ways to arrange the
                              flowers.

                              Therefore, there are $220 + 110 = 330$ ways to arrange the artificial flowers.
                              $\eos$
                  \end{enumerate}
