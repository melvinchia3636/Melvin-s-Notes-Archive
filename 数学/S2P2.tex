...
\begin{multicols}{2}
  ...
  \begin{enumerate}
    ...
    \item Rearranging all the letters in the word \textit{NUMERIACAL}, how many ways can
          ...
          There are $\permtwo[10]{10} = 10! = 3628800$ ways to arrange the 10 letters in
          the word. If all vowels are to be put together, we can treat 4 of the vowels as
          one letter, and there are $\permtwo[6]{6} = 6!$ ways to arrange the 7 letters.
    ...
    \item Examinations of 7 subjects are to be arranged in a row of 7 days, with one
          ...
          Therefore, there are $\perm[7]{7} - \permtwo[6]{6} \cdot 2! = 5040 - 1440 =
  ...
  \begin{enumerate}
    ...
    \item  When there are only 7 digits, there are 8 ways to choose the first digit (2 -
          ...
          10), 10 ways to choose the rest of the digits (0 - 10). Hence, there are $8
            \cdot 10^6$ phone numbers. When there are 8 digits, there are 8 ways
