...
\begin{multicols}{2}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=0.5]
      ...
      \node at (2.5, -1) {\footnotesize{Perfectly Positive Correlation}};
    \end{tikzpicture}
    \hspace{1cm}
    \begin{tikzpicture}[scale=0.5]
      \draw[->] (0, 0) -- (5, 0);
      ...
      \node at (2.5, -1) {\footnotesize{Perfectly Negative Correlation}};
    \end{tikzpicture}
  \end{center}
  \begin{center}
    \begin{tikzpicture}[scale=0.5]
    ...
    \begin{tikzpicture}[scale=0.5]
      \draw[->] (0, 0) -- (5, 0);
      \draw[->] (0, 0) -- (0, 5);
      \node at (2.5, -1) {\footnotesize{Strong Negative Correlation}};
    \end{tikzpicture}
  \end{center}
  \begin{center}
    \begin{tikzpicture}[scale=0.5]
