...
\begin{multicols}{2}
  ...
  \begin{enumerate}
    ...
    \item Following are the weight of 15 boys with same age:
          ...
          \end{flalign*}
          \begin{enumerate}
            \item Find the median of these 15 boys
    ...
    \item The following table shows the income of employees in a company:
          ...
          \end{center}
          \begin{enumerate}
            \item Find the median of their income using cumulative frequency polygon.
    ...
    \item The table below shows the distribution of height of 20 students:
          ...
          \begin{enumerate}
            \item The value of $x$.
            \item The median of their height.
          \end{enumerate}
  ...
  \begin{enumerate}[label=(\alph*)]
    ...
    \item Find the mode of score of the students using histogram.
    \item Find the mode of score of the students using formula.
  \end{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Given that the mean of a dataset containing positive integers is 3, 5, 8, 6, 8,
          10, 5, 3, $x$, $y$,
          \begin{enumerate}
            \item Prove that $x+y = 12$
            \item With that, if
                  \begin{enumerate}
                    \item $x = y$
                    \item $x < y$
