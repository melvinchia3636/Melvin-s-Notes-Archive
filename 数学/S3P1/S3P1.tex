...
\end{cequation}
exists, $y = f(x)$ is said to be \textbf{differentiable} at $x =
  x_0$, and the limit is called the \textbf{derivative} of $y = f(x)$ at $x =
...
\begin{mdframed}[style=MyFrame]
  ...
  \end{cequation}
\end{mdframed}
If the limit above does not exist, $y = f(x)$ is said to be \textbf{non-differentiable} at $x = x_0$.
...
derivative value $f'(x_0)$, thus forming a new function in the interval $(a,
  b)$. This new function is called the \textbf{derivative function} of $f(x)$,
denoted as $f'(x)$ or $y'$.
...
$f'(x)$ at $x = x_0$, and is called the \textbf{derivative value} at $x = x_0$.
